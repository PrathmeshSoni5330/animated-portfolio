const works = {
    ...
    experiences: [
        {
            company: 'SHARE IIT Kharagpur',
            jobs: [
                {
                    role: 'Associate',
                    duration: 'Onsite | Aug 2024 - Present',
                    points: [
                        `At SHARE IIT Kharagpur, I worked on strategic consulting projects, helping businesses optimize operations, improve financial models, and develop growth strategies. `,
                        " I conducted market research, financial analysis, and competitive benchmarking to provide data-driven recommendations. By applying structured problem-solving frameworks, I helped businesses tackle real-world challenges efficiently.",
        ...
        {
            company: 'Debating Society IIT Kharagpur',
            jobs: [
                {
                    role: 'Debater',
                    duration: 'Onsite | Aug 2024 - Present',
                    points: [
                        `As a debater at the Debating Society, IIT Kharagpur, I honed my skills in critical thinking, argumentation, and public speaking.`,
                        "I participated in competitive debates, analyzing complex issues and presenting well-structured arguments under pressure. My role involved researching diverse topics, developing persuasive narratives, and engaging in intellectual discourse with teams from various institutions.",
                        'Through this, I refined my ability to think on my feet, articulate ideas clearly, and defend positions effectively.'
                    ],
                }
            ]
        },
